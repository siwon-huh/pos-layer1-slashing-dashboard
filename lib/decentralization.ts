...
export const DECENTRALIZATION: readonly DecentralizationData[] = [
  {
    ...
    nakamotoNote: {
      ko: '검증자 키는 1M+개지만 스테이킹 주체(staking entity) 기준. Lido(~28%) + Coinbase + Binance가 ⅓ 초과.',
      en: 'There are 1M+ validator keys, but measured by staking entities: Lido (~28%) + Coinbase + Binance cross ⅓.',
    },
    ...
    notes: {
      ko: '키 개수는 매우 많지만 실질적 탈중앙화는 스테이킹 엔티티 집중도로 측정됨. Lido의 높은 점유율이 주된 중앙화 리스크.',
      en: 'Key count is very high but effective decentralization is measured by staking-entity concentration. Lido\'s large share is the main centralization risk.',
    },
    lastUpdated: '2026-04',
  ...
  },
  {
    ...
    nakamotoCoefficient: null,
    nakamotoNote: {
      ko: 'Ethereum과 동일한 Gasper를 사용하나 공개 NC 측정치가 제한적. 검증자 키 수 기준 매우 분산.',
      en: 'Uses the same Gasper as Ethereum but published NC measurements are limited. Very distributed by validator-key count.',
    },
  ...
  },
  {
    ...
    nakamotoCoefficient: null,
    nakamotoNote: {
      ko: 'L2 단일 sequencer 운영 (Worldcoin Foundation). 검증자 탈중앙화 개념 미적용.',
      en: 'L2 with a single sequencer (Worldcoin Foundation). Validator decentralization does not apply.',
    },
    activeValidators: 1,
    validatorCap: 1,
    minStake: { ko: '해당 없음 (sequencer 퍼미션드)', en: 'N/A (permissioned sequencer)' },
    permissioning: 'permissioned',
    top33SharePct: null,
    clientDiversity: 'single',
    clientDiversityNote: { ko: 'Geth sequencer + Reth shadow', en: 'Geth sequencer with Reth shadow' },
    lastUpdated: '2026-04',
    sourceUrls: ['https://l2beat.com/scaling/projects/world'],
  },
  {
    chainId: 'osmosis',
  ...
  },
  {
    ...
    nakamotoCoefficient: null,
    nakamotoNote: {
      ko: 'L2 단일 sequencer. 보안은 Ethereum settlement + Celestia DA에 상속.',
      en: 'L2 with a single sequencer; security inherited from Ethereum settlement and Celestia DA.',
    },
    activeValidators: 1,
    validatorCap: 1,
    minStake: { ko: '해당 없음 (sequencer 퍼미션드)', en: 'N/A (permissioned sequencer)' },
    ...
    top33SharePct: null,
    clientDiversity: 'single',
    clientDiversityNote: { ko: 'SVM (Solana Virtual Machine) 포크', en: 'SVM (Solana Virtual Machine) fork' },
    lastUpdated: '2026-04',
    sourceUrls: ['https://www.eclipse.xyz/'],
  },
  {
    chainId: 'mantra',
    nakamotoCoefficient: 6,
  ...
  },
  {
    ...
    clientDiversity: 'single',
    notes: {
      ko: 'Bitcoin L2. 초기 PoS 레이어 검증자는 Bitlayer Labs 및 파트너 중심. BitVM으로 Bitcoin L1 보안 상속.',
      en: 'Bitcoin L2. Early PoS-layer validators dominated by Bitlayer Labs and partners. Inherits Bitcoin L1 security via BitVM.',
    },
    lastUpdated: '2026-04',
    sourceUrls: ['https://docs.bitlayer.org/'],
  },
  {
    chainId: 'vana',
    nakamotoCoefficient: null,
